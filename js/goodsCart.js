define(["jquery", "jquery-cookie"], function ($) {
  ...
  function isCheckAll() {
    ...
    allChecks.each(function (index, item) {
      if (!$(item).find(".col-check i").hasClass("icon-checkbox-selected")) {
        ...
        total +=
          parseFloat($(item).find(".col-price").html().trim()) *
          parseFloat($(item).find(".col-num input").val());
    ...
    $("#J_cartListBody .J_cartGoods").on(
      ...
      function () {
        ...
        var price = parseFloat(
          $(this).closest(".col-num").siblings(".col-price").html().trim()
        );
        $(this)
          .closest(".col-num")
          .siblings(".col-total")
  ...
  function cartHover() {
    $("#J_miRecommendBox .xm-recommend ul.row").on(
      "mouseenter",
      ".J_xm-recommend-list",
      function () {
